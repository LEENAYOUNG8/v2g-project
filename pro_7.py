...
def main():
    ...
    # --- 그래프: 누적 라인 ---
    os.write(1, b'cumulate cashflow')
    ...
    # --- 그래프: 연도별 누적 막대 ---
    os.write(1, b'yearly cumulative bar graph')
    ...
    # --- 표: 연도별 금액 ---
    os.write(1, b'yearly cashflow table')
    ...
    # 참고 정보
    os.write(1, b'additional information')
    st.caption(
